...
A: Создайте новую ветку из текущего состояния: `git checkout -b fix/название`, затем отправьте её. Или откатите коммит: `git reset HEAD~1` (изменения останутся, но коммит отменится).
